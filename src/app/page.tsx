...
export default function Home() {
  return (
    <div className='bg-bg dark:bg-darkbg text-text dark:text-darktext flex flex-col items-center h-screen'>
      <Header/>
      <div className='flex flex-col items-center justify-center align-middle m-auto border border-slate-300 p-6 rounded-lg border-opacity-40 -translate-y-8 divGlow'>
